...
describe('AuthController', () => {
  ...
  describe('register', () => {
    it('should register a user', () => {
      ...
      expect(authController.register(token)).resolves.toEqual(result);
  ...
  describe('login', () => {
    it('should loign a user', async () => {
      ...
      expect(authController.login(token)).resolves.toEqual(result);
  ...
  describe('blockToken', () => {
    it('should block a token', async () => {
      ...
      expect(authController.tokenBlock(token)).resolves.toBe(true);
